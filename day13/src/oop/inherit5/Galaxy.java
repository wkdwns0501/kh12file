...
public class Galaxy {
	//공통 필드 
	//- 접근제한을 주의
	//- private 을 사용한다면 이 클래스에서 정한 방식으로만 이용이 가능!
	//- protected 를 사용한다면 자식 클래스(+패키지)만큼은 자유롭게 접근이 가능!
	//상위 클래스의 필드는 웬만하면 protected로 설정
	...
	//super에 있는 메소드를 this에서 다시 정의
	public void call() {                       //바뀌어도 됨
		System.out.println("전화 기능");
	}
	public final void battery() {                 //바뀌면 안됨
