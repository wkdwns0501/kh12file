...
public class Test08 {
	public static void main(String[] args) {
		...
		System.out.println(a.getYear()); //년도만 뽑기
		System.out.println(a.getMonthValue()); //월을 숫자로 뽑기 getMonth는 영어로 나온다
		System.out.println(a.getDayOfMonth()); //일만 뽑기
		
		LocalDate b = LocalDate.parse("2023-11-29"); //해석(변환)
		System.out.println(b);
		
		LocalDate c = LocalDate.now(); //지금
